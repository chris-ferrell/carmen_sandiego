...
-- this SQL command selects all the countries in "Southern Europe" in the ascending order of population size
...
SELECT * FROM countrylanguage WHERE langauge-'Italian' ORDER BY percentage DESC
...
-- She's in __santa monica_ca___________________!
